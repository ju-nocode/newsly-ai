...
export const translationIds = {
    ...
    'settings.firstName': 'settings_first_name',
    'settings.lastName': 'settings_last_name',
    ...
    'settings.firstNameEmpty': 'settings_first_name_empty',
    'settings.lastNameEmpty': 'settings_last_name_empty',
...
const fallbackTranslations = {
    fr: {
        ...
        'settings.emailHint': 'Adresse email de connexion (non modifiable)',
        'settings.firstName': 'Prénom',
        'settings.firstNameHint': 'Votre prénom',
        'settings.lastName': 'Nom',
        'settings.lastNameHint': 'Votre nom de famille',
        'settings.phone': 'Téléphone',
        'settings.phoneHint': 'Numéro de téléphone (optionnel)',
        'settings.bio': 'Bio',
        'settings.bioHint': 'Courte présentation (optionnel)',
        'settings.bioPlaceholder': 'Quelques mots sur vous...',
        ...
        'settings.updateProfile': 'Enregistrer les modifications',
        ...
        'settings.firstNameEmpty': 'Le prénom ne peut pas être vide',
        'settings.lastNameEmpty': 'Le nom ne peut pas être vide',
        'settings.updateError': 'Erreur lors de la mise à jour',
        'settings.countryHint': 'Pays de résidence',
        'settings.cityHint': 'Ville de résidence',
    ...
    en: {
        ...
        'settings.photo': 'Photo',
        'settings.email': 'Email',
        'settings.emailHint': 'Login email address (non-editable)',
        'settings.firstName': 'First name',
        'settings.firstNameHint': 'Your first name',
        'settings.lastName': 'Last name',
        'settings.lastNameHint': 'Your last name',
        'settings.phone': 'Phone',
        'settings.phoneHint': 'Phone number (optional)',
        'settings.bio': 'Bio',
        'settings.bioHint': 'Short description (optional)',
        'settings.bioPlaceholder': 'A few words about you...',
        ...
        'settings.updateProfile': 'Save changes',
        ...
        'settings.firstNameEmpty': 'First name cannot be empty',
        'settings.lastNameEmpty': 'Last name cannot be empty',
        'settings.updateError': 'Error during update',
        'settings.countryHint': 'Country of residence',
        'settings.cityHint': 'City of residence',
