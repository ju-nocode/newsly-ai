    ...
    <nav class="navbar dashboard-nav">
        <div class="nav-container">
            ...
            <a href="dashboard.html" class="logo">
                <img src="https://img.icons8.com/ios-filled/50/FFFFFF/news.png" alt="News" class="logo-icon icon-white">
                ...
                <div class="burger-dropdown" id="burgerMenu">
                    ...
                    <div class="burger-item">
                        <div class="burger-item-label">
                            <img src="https://img.icons8.com/ios-filled/50/000000/moon-symbol.png" alt="Theme" class="icon-secondary">
                    ...
                    <div class="burger-item">
                        <div class="burger-item-label">
                            <img src="https://img.icons8.com/ios-filled/50/000000/globe.png" alt="Language" class="icon-secondary">
                    ...
                    <button class="burger-link" id="dashboardBtn">
                        <img src="https://img.icons8.com/ios-filled/50/000000/dashboard.png" alt="Dashboard" class="icon-secondary">
                        <span data-i18n="nav.dashboard">Dashboard</span>
                    </button>
                    ` : `
                    <button class="burger-link" id="settingsBtn">
                        <img src="https://img.icons8.com/ios-filled/50/000000/settings.png" alt="Settings" class="icon-secondary">
                        <span data-i18n="nav.settings">Paramètres</span>
                    </button>
                    `}

                    <button class="burger-link" id="logoutBtn">
                        <img src="https://img.icons8.com/ios-filled/50/000000/exit.png" alt="Logout" class="icon-secondary">
